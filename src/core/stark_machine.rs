...
pub const INPUT_SIZE: usize = ZPTR_SIZE + DIGEST_SIZE;
pub const NUM_PUBLIC_VALUES: usize = INPUT_SIZE + ZPTR_SIZE;

/// Returns a `StarkMachine` for the Lurk toplevel, with `lurk_main` as entrypoint
pub fn new_machine<C1: Chipset<BabyBear>, C2: Chipset<BabyBear>>(
